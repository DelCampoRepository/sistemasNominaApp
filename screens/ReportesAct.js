...
const ReporteAct = ({ route, navigation }) => {
  ...
  const Actividad = ({
    ...
    >
      ...
      <Text style={styles.surcoCodigoActividad}>
        {" "}{CodigoActividad} - {CodigoAvance}
      </Text>
      <View
        style={{
          alignItems: "center",
      ...
      <View style={styles.surcoCantSurcosContainer}>
        ...
        <View style={styles.surcoCantSurcosValorCaja}>
          <Text style={styles.surcoCantSurcosValor}>
            {CantidadSurcos}
          </Text>
        </View>
      </View>
  ...
  return (
    <View style={styles.contenedor}>
      <View style={styles.headerContainer}>
        ...
        <Text style={styles.headerDetailText}>
          {tablaLabel ? ` ${tablaLabel}` : "Cargando Tabla..."}
        </Text>
        {codigoEmpleado &&
          nombre &&
          <Text style={styles.headerDetailText}>
            {codigoEmpleado} - {nombreCapitalizado}{" "}
          </Text>}

        <Text style={styles.headerDetailText}>
          Del {formattedFechaInicio} Al {formattedFechaFin}
        </Text>
      </View>
